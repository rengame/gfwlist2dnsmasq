...
./gfwlist2smartdns.sh -g vpn -s gfwlist -o ./test.conf -t smartdns --exclude-domain-file exclude.domain --extra-domain-file extra.domain -o gfwlistforsmartdns.conf
